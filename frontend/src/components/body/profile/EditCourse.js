...
const EditCourse = ({ history }) => {
  ...
  const handleUpdate = () => {
    ...
    if (name.length === 0) {
      message.error("You must add course name");
    }
    if (price.length === null) {
      message.error("You must add course price");
    }
    if (goals.length === 0) {
      message.error("You must add course goals");
    }
    if (category.length === 0) {
      message.error("You must add course category");
    }
    if (image.length === 0) {
      message.error("You must add course image");
    }
    if (Prerequisites.length === 0) {
      message.error("You must add course requirement");
    }
    if (description.length === 0) {
      message.error("You must add course description");
    }
    if (audience.length === 0) {
      message.error("You must add course audience");
    }
    if (subcategorys.length === 0) {
      message.error("You must add course subcategory");
    }
    if (shortdescription.length === 0) {
      message.error("You must add course shortdescription");
    }
    else {
      dispatch(
        UpdateCourse({
